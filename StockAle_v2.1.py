...
from  StockAleUI_v2 import Ui_MainWindow
from classes import * 
try:
...
class Mainwindow (QtGui.QMainWindow):
    ...
    def deleteUsedYeast(self):
        ...
        row = self.ui.yeast_use.currentRow()
        column = self.ui.yeast_use.currentColumn()
        sel = self.ui.yeast_use.item(row, column)
        row = int(row)
        self.used_yeast_list.pop(row)
        self.usedYeast_update()
